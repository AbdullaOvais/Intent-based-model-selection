...
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parents[1] / "artifacts" / "exp1_models" / "logistic_regression"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Logistic Regression on exp1 handover windows.")
...
def main() -> None:
    ...
    save_pickle(output_dir / "logistic_regression.pkl", {"model": model})
    save_json(
    ...
    save_json(
        output_dir / "catalog_entry.json",
        {
            ...
            "tags": ["exp1", "handover", "tabular", "supervised", "linear"],
            "description": "Logistic Regression trained on normal vs anomaly handover windows.",
        },
    )
