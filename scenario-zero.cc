...
static ns3::GlobalValue
    g_timeToTrigger ("TimeToTrigger",
                     "Time-to-trigger for A3-RSRP handover algorithm (ms)",
...
main (int argc, char *argv[])
{
  ...
  GlobalValue::GetValueByName ("TimeToTrigger", uintegerValue);
  uint32_t TimeToTrigger = uintegerValue.Get ();
